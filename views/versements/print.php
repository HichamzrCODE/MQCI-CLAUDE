...
<head>
  <meta charset="utf-8">
  <title>Bordereau Versement - <?= htmlspecialchars($versement['numero']) ?></title>
  <style>
...
<body>
  <div class="wrap">
    ...
    <div class="top">
      ...
      <div class="right">
        ...
        <div><b><?= htmlspecialchars($versement['client_nom'] ?? '') ?></b></div>
      </div>
    </div>
    ...
    <div class="sign">
      <div>
        <div class="muted">Signature caisse</div>
        <div class="area"></div>
      </div>
      <div>
        <div class="muted">Signature client</div>
        <div class="area"></div>
      </div>
    </div>
  </div>
  ...
  <script>
    // Auto-ouverture de la boîte d'impression (optionnel)
