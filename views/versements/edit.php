...
$error = $error ?? null;
if (!$versement) { echo "Versement introuvable."; return; }
...
<div class="container mt-4" style="max-width: 900px;">
  ...
  <div class="d-flex justify-content-between align-items-center mb-3">
    <div>
      <h4 class="mb-0">Versement <?= htmlspecialchars($versement['numero']) ?></h4>
      <div class="text-muted small">
        Client: <b><?= htmlspecialchars($versement['client_nom'] ?? '') ?></b>
        &nbsp;•&nbsp;
        Mode:
    ...
    <div class="btn-group">
      ...
      <a class="btn btn-outline-primary btn-sm"
         target="_blank"
         href="index.php?action=versements/print&id=<?= (int)$versement['id'] ?>">
        Imprimer bordereau
      </a>
    </div>
  </div>
  ...
  <div class="card">
    <div class="card-body p-3">
      ...
      <form method="post" action="index.php?action=versements/edit&id=<?= (int)$versement['id'] ?>" autocomplete="off">
        <?= $csrf_field ?? '' ?>
          ...
          <div class="form-group col-md-3 mb-2">
            ...
            <select name="statut" class="form-control form-control-sm" required>
              <?php
                ...
                $options = ['en_attente'=>'En attente','encaisse'=>'Encaissé','rejete'=>'Rejeté','annule'=>'Annulé'];
          ...
          <div>
            ...
            <?php if (($versement['statut'] ?? '') !== 'annule'): ?>
              <a class="btn btn-outline-danger btn-sm"
                 href="index.php?action=versements/cancel&id=<?= (int)$versement['id'] ?>"
