...
<div class="container mt-4" style="max-width:900px;">
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <?php
$pr = $article['pr'] ?? 0;
$pd = $article['prix_detail'] ?? $article['prix_vente'] ?? 0;
$ps = $article['prix_semi_gros'] ?? null;
$pg = $article['prix_gros'] ?? null;
?>
        ...
        <div class="row text-center">
            <div class="col-md-3 col-6 mb-2">
                <div class="p-2 bg-light rounded">
                    ...
                    <div class="font-weight-bold"><?= number_format((float)$pr, 0, ',', ' '); ?></div>
                </div>
            </div>
            <div class="col-md-3 col-6 mb-2">
                <div class="p-2 bg-light rounded">
                    <div class="text-muted small">Détail</div>
                    <div class="font-weight-bold"><?= $pd ? number_format((float)$pd, 0, ',', ' ') : '<span class="text-muted">-</span>'; ?></div>
                </div>
            </div>
            <div class="col-md-3 col-6 mb-2">
                <div class="p-2 bg-light rounded">
                    <div class="text-muted small">Semi-gros</div>
                    <div class="font-weight-bold"><?= $ps !== null ? number_format((float)$ps, 0, ',', ' ') : '<span class="text-muted">-</span>'; ?></div>
                </div>
            </div>
            <div class="col-md-3 col-6 mb-2">
                <div class="p-2 bg-light rounded">
                    <div class="text-muted small">Gros</div>
                    <div class="font-weight-bold"><?= $pg !== null ? number_format((float)$pg, 0, ',', ' ') : '<span class="text-muted">-</span>'; ?></div>
                </div>
            </div>
        </div>
    </div>
